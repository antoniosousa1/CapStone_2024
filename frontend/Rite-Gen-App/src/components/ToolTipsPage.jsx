...
const helpItems = [
  ...
  { title: "Upload, edit, or delete documents from the 'Documents' tab.", label: 'Managing Documents' },
  { title: 'Evaluate responses based on precision, faithfulness, and relevancy.', label: 'Evaluating AI Performance' },
