...
# Splits the documents up and stores the chuncks of text into all_splits
...
if os.path.exists(vectorstore_path) and os.listdir(vectorstore_path):  
    ...
    # Try and except, handles any errors that might occur if the database doesn't load properly 
    try:
        ...
        # Tells user that the database was loaded successfully
...
# Else that runs if the vector data hasn't been created and stored 
    ...
    print("Creating and Storing vector database...")
